...
def siunitx_ticklabels(ax=None, locale="DE", xaxis=True, yaxis=True, round_number = 0):
    """
    ...
    if xaxis is True:
        ...
        xlabels = [r"$\num[locale={}]{{{}}}$".format(locale, int(tick)) for tick in xticks]
    ...
    if yaxis is True:
        ...
        if round_number == 0:
            ...
            ylabels = [r"$\num[locale={}]{{{}}}$".format(locale, tick.round(round_number)) for tick in yticks]
